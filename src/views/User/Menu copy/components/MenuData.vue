      ...
      <div class="text item" style="width: 100%">
        ...
        >
          <el-row>
            ...
            <el-col :span="11">
              <el-form-item :label="formLabel.hidden" prop="hidden">
                <el-switch
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item :label="formLabel.metaTitle" prop="metaTitle">
                <el-input
                  v-model="menuData.metaTitle"
                  clearable
                  :placeholder="formLabel.metaTitle"
                ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item :label="formLabel.metaIcon" prop="metaIcon">
                <el-input
                  v-model="menuData.metaIcon"
                  clearable
                  :placeholder="formLabel.metaIcon"
                ></el-input>
              </el-form-item>
            </el-col>
          </el-row>
    ...
    menuRules: function() {
      ...
      let rule = {
        metaTitle: [
          {
            required: true,
            message: `${this.formLabel.metaTitle}不能为空`,
            trigger: "blur"
          }
        ],
        name: [
